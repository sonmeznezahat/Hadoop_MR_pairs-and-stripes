 ...
 * @author Jimmy Lin
 */
public class stripes_pmi extends Configured implements Tool
{
	private static final Logger LOG = Logger
			.getLogger(stripes_pmi.class);
	...
	public int run(String[] argv) throws Exception {
		...
		job.setJobName(stripes_pmi.class.getSimpleName());
		job.setJarByClass(stripes_pmi.class);
	...
	public static void main(String[] args) throws Exception {
		ToolRunner.run(new stripes_pmi(), args);
	}
}
